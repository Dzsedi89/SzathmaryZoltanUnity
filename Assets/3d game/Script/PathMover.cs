 ...
 class PathMover : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 p = Vector3.Lerp(p1, p2, startPoint); //LERP: lineáris interpoláció, ezzel tudunk köztes értékeket adni valaminek, keverni két értéket!!!
        
        nextTarget = t2.position;
        movable.position = t1.position;
    }
